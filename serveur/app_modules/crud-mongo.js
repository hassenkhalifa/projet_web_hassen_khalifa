...
exports.findCaddie = function (callback) {
	MongoClient.connect(url, function (err, client) {
...
exports.createCaddie = function (formData, callback) {
	MongoClient.connect(url, function (err, client) {
		var db = client.db(dbName);
...
exports.deleteCaddie = function (id, callback) {
	MongoClient.connect(url, function (err, client) {
		var db = client.db(dbName);
